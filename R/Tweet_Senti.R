...
#                destfile = "cacert.pem")
#  setup_twitter_oauth('NCCLQ4oWtJLDzhjoSzM386v8k', # api key
#                      'zH7tHBy4jMpOqB9MoAqMokoEjfcHEhIRy8lVrlTIzD8q3VCAoH', # api secret
#                    '47884221-LkiSIE7qXH0nCW3v9j2QkRek22jeC57wZ6bbkwFj4', # access token
#                      'eqDmnkef6rbK0PPl4Dpe4HBcJ7n93W6FYO7pXABkbwJjX' # access token secret
#  )
#
...
#save(df_tweets,file='df_tweet.RData')
